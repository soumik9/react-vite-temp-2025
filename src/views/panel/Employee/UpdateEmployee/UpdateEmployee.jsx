...
import { useGetEmployeeQuery, useUpdateEmployeeMutation } from '@/redux-rtk/features/employee/employeeApi';
...
const UpdateEmployee = ({ employeeId }) => {
    ...
    const handleUpdateEmployee = (e) => {
        ...
        // rtk query called
        updateEmployee({ employeeId, formData }).unwrap()
            .then(response => {
                if (response.success) {
    ...
    return (
        <CardLayout isLoading={isLoading} isError={isError} isSuccess={isSuccess}>
            <form action="" onSubmit={handleUpdateEmployee} className='grid md:grid-cols-2 gap-y-4 md:gap-x-6'>
